...
const QUESTIONS = [
  ...
  {
    text: "เจอข้อมูลหรือความรู้ใหม่ที่น่าสนใจ คุณมักจะ...",
    weight: 2,
    options: [
      { move: "connector", text: "เก็บไว้แล้วคิดว่ามันโยงกับเรื่องอื่นที่เคยรู้มาก่อนยังไง" },
      { move: "meaningmaker", text: "อยากแชร์หรือเล่าให้คนอื่นฟังต่อทันที" },
