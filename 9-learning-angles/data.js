...
const QUESTIONS = [
  ...
  },
  {
    ...
    weight: 2,
    options: [
      { move: "connector", text: "นึกว่ามันเชื่อมกับเรื่องอื่นที่เคยดูหรือเคยรู้มาก่อนยังไง" },
      { move: "meaningmaker", text: "อยากเล่าให้คนอื่นฟังต่อทันที" },
      { move: "creator", text: "เอาแรงบันดาลใจไปทำเป็นไอเดียใหม่ของตัวเอง" },
    ],
  },
  {
